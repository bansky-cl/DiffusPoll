...
os.environ["WANDB_API_KEY"] = "use your own wandb"
...
def main():
    ...
    print("### dataset_unsup is",args.dataset_unsup)
    data = load_data_text(
    ...
    #     print("### use mix model load data_unsup...")
    ...
    TrainLoop(
        ...
        mix=args.mix, ## use mix fp16 &32
        data_unsup=data_unsup, ### add data
        pad_emb=pad_emb, ### add 0 embedding 
    ).run_loop()
